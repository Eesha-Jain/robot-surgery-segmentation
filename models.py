...
class UNet11Simple(nn.Module):
    def __init__(self, num_classes=1, num_filters=32, pretrained=False, simple=False):
        """
        :param num_classes:
        :param num_filters:
        :param pretrained:
        ...
        if not self.simple:
            ...
            self.conv3 = nn.Sequential(self.encoder[6], self.encoder[8])
            self.conv4 = nn.Sequential(self.encoder[11], self.encoder[13])
